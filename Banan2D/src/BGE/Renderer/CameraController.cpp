...
namespace Banan
{
	...
	void OrthographicCameraController::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrollEvent>	(BGE_BIND_EVENT_FN(OrthographicCameraController::OnMouseScroll));
		dispatcher.Dispatch<WindowResizeEvent>	(BGE_BIND_EVENT_FN(OrthographicCameraController::OnWindowResize));
	}
